...
//        }
       ...
       // int bitrate = 2 * mWidth * mHeight / 3;
        ...
        Log.i(TAG, "startMediaCodec: ----------------"+Build.MODEL+debugger.getEncoderName());
        Log.i(TAG, "startMediaCodec: ----------------"+debugger.getEncoderColorFormat());
        MediaFormat mediaFormat = MediaFormat.createVideoFormat("video/avc", mWidth, mHeight);
        mediaFormat.setInteger(MediaFormat.KEY_BIT_RATE, bitrate);
        mediaFormat.setInteger(MediaFormat.KEY_FRAME_RATE, framerate);
        if(Build.MODEL.contains("OPPO")||Build.MODEL.contains("VIVO")){
