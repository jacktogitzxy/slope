...
public class PlayActivity extends AppCompatActivity {
    ...
    private TextView stream_bps,msgTxt;
    private int mActionStartSound;
    private int mActionStopSound;
    private ImageButton liveVideoBarRecord,liveVideoBarTakePicture,liveVideoBarEnableAudio;
    ...
    private final Runnable mTimerRunnable = new Runnable() {
        ...
        public void run() {
            ...
            stream_bps.setText((length - mLastReceivedLength) / 1024 + "Kbps");
    ...
    public void onTakePicture(View view) {
        ...
        if (permissionCheck == PackageManager.PERMISSION_GRANTED) {
            File file = new File(Constantplay.getsPicturePath(PlayActivity.this));
            file.mkdirs();
    ...
    private void initview() {
        liveVideoBarRecord = findViewById(R.id.live_video_bar_record);
        liveVideoBarTakePicture = findViewById(R.id.live_video_bar_take_picture);
        liveVideoBarEnableAudio = findViewById(R.id.live_video_bar_enable_audio);
        playerContainer = findViewById(R.id.player_container);
        renderHolder = findViewById(R.id.render_holder);
