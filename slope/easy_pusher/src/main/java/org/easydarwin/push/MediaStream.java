...
import static org.easydarwin.easypusher.StreamActivity.BUS;
...
//                        cameraRotationOffset += 180;
    ...
    public void startStream(String url, InitCallback callback) {
        if (PreferenceManager.getDefaultSharedPreferences(mApplicationContext).getBoolean(StreamActivity.KEY_ENABLE_VIDEO, true)) {
