...
public class Config {
    ...
    public static final String DEFAULT_SERVER_URL ="rtmp://47.107.32.201:1935/live/"+String.valueOf((int) (Math.random() * 1000000 + 100000))+"&channel=1"; //"rtmp://demo.easydss.com:10085/hls/stream_"+String.valueOf((int) (Math.random() * 1000000 + 100000));
